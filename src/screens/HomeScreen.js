...
function HomeScreen() {
  ...
  const handleAdminPageNavigation = () => {
    ...
    Linking.openURL(adminUrl).catch(() =>
      Alert.alert('오류', '관리자 페이지를 열 수 없습니다.'),
    );
  };
      ...
      <View style={styles.statItem}>
        ...
        {loadingStats ? (
          ...
          <Text style={styles.statValue}>
            {stats.todayHelpCount?.toLocaleString() ?? 0}
          </Text>
        )}
      </View>
      <View style={styles.statItem}>
        ...
        {loadingStats ? (
          ...
          <Text style={styles.statValue}>
            {stats.totalHelpCount?.toLocaleString() ?? 0}
          </Text>
        )}
      </View>
      <View style={styles.statItem}>
        ...
        {loadingStats ? (
          ...
          <Text style={styles.statValue}>
            {stats.totalScamCount?.toLocaleString() ?? 0}
          </Text>
        )}
      </View>
    </View>
      ...
      <ScrollView
        ...
        <View style={styles.headerSection}>
          ...
          <Text style={styles.greetingText}>
            {profile?.nickname || user?.email || '방문자'}님, 안전한 금융거래를
            하실 수 있도록 최선을 다하겠습니다.
          </Text>
        </View>
