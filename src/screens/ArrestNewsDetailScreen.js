    ...
    try {
      const { data, error: fetchError } = await supabase
        ...
        .select(`
          ...
          arrest_status, reported_to_police, police_station:police_stations (id, name, region, address)
        `)
        .eq('id', newsId)
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView
        ...
        <View style={styles.statusSection}>
          ...
          {news.reported_to_police && news.police_station ? (
            <View style={styles.statusInfoRow}>
              <Text style={styles.statusInfoLabel}>신고 경찰서</Text>
              <Text style={styles.statusInfoValue}>
                {news.police_station.name}
                {news.police_station.region
                  ? ` (${news.police_station.region})`
                  : ''}
              </Text>
            </View>
