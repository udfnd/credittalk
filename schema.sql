...
CREATE OR REPLACE FUNCTION "public"."get_help_questions_with_status"() RETURNS TABLE("id" bigint, "user_id" "uuid", "title" "text", "created_at" timestamp with time zone, "case_summary" "text", "is_answered" boolean)
    LANGUAGE "plpgsql" STABLE SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
BEGIN
  PERFORM net.http_post(
    ...
    headers:='{"Content-Type":"application/json","Authorization":"Bearer REMOVED_SUPABASE_SERVICE_ROLE_KEY"}'::jsonb,
...
BEGIN
  PERFORM net.http_post(
    ...
    headers:='{
      ...
      "Authorization": "Bearer REMOVED_SUPABASE_SERVICE_ROLE_KEY"
    }'::jsonb,
...
COMMENT ON COLUMN "public"."arrest_news"."arrest_status" IS '검거 상태 (arrested, active)';



COMMENT ON COLUMN "public"."arrest_news"."reported_to_police" IS '경찰 신고 여부';



COMMENT ON COLUMN "public"."arrest_news"."police_station_id" IS '신고한 경찰서 참조';
...
COMMENT ON TABLE "public"."police_stations" IS '전국 경찰서 정보';



COMMENT ON COLUMN "public"."police_stations"."name" IS '경찰서 이름';



COMMENT ON COLUMN "public"."police_stations"."region" IS '소속 지역';



COMMENT ON COLUMN "public"."police_stations"."address" IS '주소';



ALTER TABLE "public"."police_stations" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."police_stations_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."arrest_news_reports" (
    "id" bigint NOT NULL,
    "arrest_news_id" bigint NOT NULL,
    "user_id" "uuid" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"()
);


ALTER TABLE "public"."arrest_news_reports" OWNER TO "postgres";


COMMENT ON TABLE "public"."arrest_news_reports" IS '검거소식 누적 신고 기록';



COMMENT ON COLUMN "public"."arrest_news_reports"."arrest_news_id" IS '검거소식 게시글 ID';



COMMENT ON COLUMN "public"."arrest_news_reports"."user_id" IS '신고한 사용자 auth.users ID';



ALTER TABLE "public"."arrest_news_reports" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."arrest_news_reports_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."arrest_news"
    ADD CONSTRAINT "arrest_news_police_station_id_fkey" FOREIGN KEY ("police_station_id") REFERENCES "public"."police_stations"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."blocked_users"
    ADD CONSTRAINT "blocked_users_blocked_user_id_fkey" FOREIGN KEY ("blocked_user_id") REFERENCES "public"."users"("auth_user_id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."blocked_users"
    ADD CONSTRAINT "blocked_users_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("auth_user_id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."reports"
    ADD CONSTRAINT "reports_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."users"("auth_user_id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."reports"
    ADD CONSTRAINT "reports_reporter_id_fkey" FOREIGN KEY ("reporter_id") REFERENCES "public"."users"("auth_user_id") ON DELETE CASCADE;
...
CREATE POLICY "Public can read police stations" ON "public"."police_stations" FOR SELECT USING (true);



CREATE POLICY "Service role can manage police stations" ON "public"."police_stations" USING (("auth"."role"() = 'service_role'::"text")) WITH CHECK (("auth"."role"() = 'service_role'::"text"));
...
CREATE POLICY "Allow full access for owner and admins" ON "public"."help_questions" FOR SELECT TO "authenticated" USING ((("user_id" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."users"
...
CREATE POLICY "Users can manage their own block list" ON "public"."blocked_users" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage their own reports" ON "public"."reports" USING (("auth"."uid"() = "reporter_id"));
...
GRANT ALL ON SEQUENCE "public"."arrest_news_reports_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."arrest_news_reports_id_seq" TO "service_role";
