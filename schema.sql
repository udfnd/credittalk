...
ALTER TABLE ONLY "public"."audio_analysis_results"
    ADD CONSTRAINT "audio_analysis_results_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id");
...
CREATE POLICY "Allow all authenticated users to view all questions" ON "public"."help_questions" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));
